...
**동결 시점 = 그 셋을 처음 만난 엔진의 성적**이고, **지금 = 2026-08-27 의 엔진
...
누적 865건: Precision **0.9872** / Recall **0.9767** / F1 **0.9819** /
Accuracy 0.9803 / FPR **0.0153**. 공식 근거 coverage 는 열두 셋 전부 **1.000**.
