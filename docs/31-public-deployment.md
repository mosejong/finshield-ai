...
**아직 남은 것은 브라우저에서만 보이는 두 가지다.** 결과 화면의
「상황이 달라졌어요」(주소의 결과 id 가 바뀌는지)와 프로필 저장·삭제. 위 표의
상태 전환은 **엔진이 답을 바꾼다**는 것까지만 말해 준다 — 화면이 그 답을 다시
받아 오는지는 아직 확인되지 않았다.
